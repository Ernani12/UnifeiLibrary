...
public class Livro {
	...
	private Usuario reservedByUser;
	...
	public Livro(String title, String author, int releaseYear, int edition) {
		super();
		this.title = title;
		this.author = author;
	...
	public Usuario getReservedByUser() {
		return reservedByUser;
	}
	
	public void setReservedByUser(Usuario reservedByUser) {
