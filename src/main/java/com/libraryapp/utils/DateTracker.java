...
public class DateTracker {
	...
	public String getReservationDatesInString(Livro book) {
	...
	public int getWeeksToExtendReturnDate(Livro book) {
	...
	public Map<Livro, String> listedBookReservations(Collection <Long> bookIds){
		
		Map<Livro, String> listedBookReservations = new LinkedHashMap<Livro, String>();
		for (Long bookId : bookIds) {
			Livro reservedBookObject = bookService.findById(bookId);
